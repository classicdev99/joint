                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body" style="">
                                            <div>
                                                <a class="btn btn-primary" href="#">Today</a>
                                                <a class="btn btn-primary" href="#">Tomorrow</a>
                                                <a class="btn btn-primary" href="#">7 Days</a>
                                                <a class="btn btn-primary" href="#">30 Days</a>
                                            </div>
                                            ...
                                            <div class="wrapper col-6">
                                                ...
                                                <h4 class="header-title mb-3">Guest Checkout for Today</h4>
                                                ...
                                                <table id="booking-list" class="table table-bordered table-striped w-100" style="table-layout:fixed; word-wrap:break-word;">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td>
                                                                <h4>Total Check-out: <?= COUNT($bookings) ?></h4>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
