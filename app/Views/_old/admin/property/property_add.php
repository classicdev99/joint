                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="<?php echo base_url('admin/property_add_back');?>" method="post">
                                                <div class="row mb-3">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input class="form-control" type="text" name="name" placeholder="Enter Property Name" id="example-text-input" required>
                                                    </div>
                                                </div>
