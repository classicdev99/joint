            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form action="<?= base_url(session('role') . '/deal/edit_submit/' . $record['id']) ?>" method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="dealName" value="<?= $record['dealName'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="closingDate" value="<?= $record['closingDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="contactName" value="<?= $record['contactName'] ?>">
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="model" value="<?= $record['model'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="productName" value="<?= $record['productName'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="serialNo" value="<?= $record['serialNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="beeOpportunityNo" value="<?= $record['beeOpportunityNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="purchasedDate" value="<?= $record['purchasedDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="IRSRefer" value="<?= $record['irsRefer'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="externalLab" value="<?= $record['externalLab'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="TDODate" value="<?= $record['tdoDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="calibrationDueDate" value="<?= $record['calibrationDueDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="TDONo" value="<?= $record['tdoNo'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="quotationNo" value="<?= $record['quotationNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="quotationDate" value="<?= $record['quotationDate'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="repairDate" value="<?= $record['repairDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="inspectionDate" value="<?= $record['inspectionDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="goodsInDate" value="<?= $record['goodsInDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="orderingDate" value="<?= $record['orderingDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="invoicingDate" value="<?= $record['invoicingDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="orderingNo" value="<?= $record['orderingNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="invoicingNo" value="<?= $record['invoicingNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="distributionDate" value="<?= $record['distributionDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="sendBackDO" value="<?= $record['sendBackDo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="distributionNo" value="<?= $record['distributionNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="sendBackCustTDODate" value="<?= $record['sendBackCustTdoDate'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="customerPONo" value="<?= $record['customerPoNo'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="sendBackCustTDONo" value="<?= $record['sendBackCustTdoNo'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    <textarea class="form-control" name="costdescription"><?= $record['costDescription'] ?></textarea>
                                                </div>
                                            </div>
