                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <form action="<?= base_url(session('role').'/lead/create') ?>" method="post">
                                        <div class="card-body">
                                            <div class="d-flex flex-row-reverse">
                                                ...
                                                &ensp;
                                                <a href="<?= base_url(session('role').'/lead') ?>" class="btn btn-secondary mb-3" onclick="return confirm('Cancel adding lead?');">Cancel</a>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="secondaryemail" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        <select name="actionrequired" class="form-select">
                                                            ...
                                                            <?php foreach ($actionrequireds as $key => $actionrequired): ?>
                                                                <option value="<?=$actionrequired['id'];?>"><?=$actionrequired['name'];?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                </div>
