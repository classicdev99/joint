                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form
                                    action="<?= base_url(session('role') . '/account/save_update/' . $account[0]->id); ?>"
                                    enctype="multipart/form-data" method="POST">
                                    <input type="hidden" name="_method" value="PUT" />
                                    <div class="card-body">
                                        <div class="d-flex flex-row-reverse">
                                            <button type="submit" name="submitupdateaccount"
                                            ...
                                            <a href="<?= base_url(session('role') . '/account') ?>"
                                                ...
                                                onclick="return confirm('Cancel update account?');">Cancel</a>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="rating" class="form-select">
                                                        ...
                                                        { ?>
                                                        <option <?= $account[0]->rating==$rating['id']?'selected':''; ?>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="phonenumber" type="tel" class="form-control"
                                                        id="phonenumber" value="<?= $account[0]->phonenumber; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="industry" class="form-select">
                                                        ...
                                                        { ?>
                                                        <option
                                                            <?= $account[0]->industry==$industry['id']?'selected':''; ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="customertype" class="form-select">
                                                        ...
                                                        { ?>
                                                        <option
                                                            <?= $account[0]->customertype==$customertype['id']?'selected':''; ?>
                                                            value="<?php echo $customertype['id'];?>">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select name="paymentterm" class="form-select">
                                                        ...
                                                        { ?>
                                                        <option
                                                            <?= $account[0]->paymentterm==$paymentterm['id']?'selected':''; ?>
                                                            value="<?php echo $paymentterm['id'];?>">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select id="country" name="country" class="form-control gds-cr"
                                                        country-data-region-id="region" data-language="en"
                                                        value="<?= $account[0]->country; ?>"></select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
