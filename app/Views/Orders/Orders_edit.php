            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form action="<?= base_url(session('role') . '/Orders/edit_submit/' . $record['id']) ?>" method="POST">
                                    <div class="card-body">
                                        <div class="d-flex flex-row-reverse">
                                            <input type="submit" value="Save" class="btn btn-primary mb-3">
                                            &ensp;
                                            <a href="<?= base_url(session('role') . '/Orders') ?>" class="btn btn-secondary mb-3" onclick="return confirm('Cancel create Orders?');">Cancel</a>
                                        </div>
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select" name="order_owner" id="order_owner">
                                                        ...
                                                        <option <?= (1 == $record['order_owner'] ? 'selected="selected"' : '') ?> value="1">Owner 1</option>
                                                        <option <?= (2 == $record['order_owner'] ? 'selected="selected"' : '') ?> value="2">Owner 2</option>
                                                        <option <?= (3 == $record['order_owner'] ? 'selected="selected"' : '') ?> value="3">Owner 3</option>
                                                        <option <?= (4 == $record['order_owner'] ? 'selected="selected"' : '') ?> value="4">Owner 4</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?= $record['subject'] ?>" type="text" class="form-control" name="subject" id="subject">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend bg-danger" style="width:3px;"></div>
                                                    <input value="<?= $record['purchase_owner'] ?>" type="text" id="purchase_owner" name="purchase_owner" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?= $record['deal'] ?>" type="text" class="form-control" name="deal">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?= $record['quote_name'] ?>" type="text" class="form-control" name="quote_name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="pic_name" id="" class="form-select">
                                                        <option <?= ('PIC 1' == $record['pic_name'] ? 'selected="selected"' : '') ?> value="PIC 1">PIC 1</option>
                                                        <option <?= ('PIC 2' == $record['pic_name'] ? 'selected="selected"' : '') ?> value="PIC 2">PIC 2</option>
                                                        <option <?= ('PIC 3' == $record['pic_name'] ? 'selected="selected"' : '') ?> value="PIC 3">PIC 3</option>
                                                        <option <?= ('PIC 4' == $record['pic_name'] ? 'selected="selected"' : '') ?> value="PIC 4">PIC 4</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?= $record['quote_no'] ?>" type="text" class="form-control" name="quote_no">
                                                </div>
                                            </div>
                                            <div class="col-md-6 offset-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select name="status" id="" class="form-select">
                                                        <option <?= ('Completed' == $record['status'] ? 'selected="selected"' : '') ?> value="Completed">Completed</option>
                                                        <option <?= ('Uncompleted' == $record['status'] ? 'selected="selected"' : '') ?> value="Uncompleted">Uncompleted</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?= $record['shipping_contact'] ?>" type="text" name="shipping_contact" id="" class="form-control">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text h-100"><i class="fa fa-user"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?= $record['billing_code'] ?>" type="text" class="form-control" name="billing_code" id="billing_code">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?= $record['delivery_term'] ?>" type="text" class="form-control" name="delivery_term" id="delivery_term">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">Transporter </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['transporter'] ?>" type="text" class="form-control" name="transporter" id="transporter">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">Payment Terms </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['paymetn_terms'] ?>" type="text" class="form-control" name="paymetn_terms" id="paymetn_terms">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">Delivery ETA </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['delivery_ETA'] ?>" type="date" class="form-control" name="delivery_ETA" id="delivery_ETA">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">Prepration For Customer Site </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['custome_site_preprationsv'] ?>" type="text" class="form-control" name="custome_site_preprationsv" id="custome_site_preprationsv">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">Delivery ETA Remark </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['delivery_remark'] ?>" type="text" class="form-control" name="delivery_remark" id="delivery_remark">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="col-form-label">SE Remark </label>
                                                <div class="input-group">
                                                    <input value="<?= $record['se_remark'] ?>" type="text" class="form-control" name="se_remark" id="se_remark">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="assign_to" id="" class="form-control">
                                                            <option <?= ('Option 1' == $record['assign_to'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['assign_to'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-12	">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['install_date'] ?>" type="date" class="form-control" name="install_date" id="install_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="install_stage" id="" class="form-control">
                                                            <option <?= ('Option 1' == $record['install_stage'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['install_stage'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['install_tech'] ?>" type="text" class="form-control" name="install_tech" id="install_tech">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="callibration_assign" id="callibration_assign" class="form-control">
                                                            <option <?= ('Option 1' == $record['callibration_assign'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['callibration_assign'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-12	">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['callibration_date'] ?>" type="date" class="form-control" name="callibration_date" id="callibration_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="callibration_stage" id="callibration_stage" class="form-control">
                                                            <option <?= ('Option 1' == $record['callibration_stage'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['callibration_stage'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['callibration_tech'] ?>" type="text" class="form-control" name="callibration_tech" id="callibration_tech">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="training_asigned" id="" class="form-control">
                                                            <option <?= ('Option 1' == $record['training_asigned'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['training_asigned'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-12	">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['training_date'] ?>" type="date" class="form-control" name="install_date" id="training_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="traing_tech" id="" class="form-control">
                                                            <option <?= ('Option 1' == $record['traing_tech'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['traing_tech'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?= $record['meeting_date'] ?>" type="date" class="form-control" name="meeting_date" id="meeting_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 ">
                                                    <label class="col-form-label">Comment From Customer </label>
                                                    <div class="input-group">
                                                        <input value="<?= $record['comment'] ?>" type="text" class="form-control" name="comment" id="comment">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="submit_by" id="submit_by" class="form-control">
                                                            <option <?= ('Option 1' == $record['submit_by'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['submit_by'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="review_by" id="review_by" class="form-control">
                                                            <option <?= ('Option 1' == $record['review_by'] ? 'selected="selected"' : '') ?> value="Option 1">Option 1</option>
                                                            <option <?= ('Option 2' == $record['review_by'] ? 'selected="selected"' : '') ?> value="Option 2">Option 2</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="terms_conditions" id="" cols="30" rows="" class="form-control"><?= $record['terms_conditions'] ?></textarea>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="description" id="" cols="30" rows="" class="form-control"><?= $record['description'] ?></textarea>
                                                </div>
                                            </div>
