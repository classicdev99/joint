    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a href="javascript:void(0);" class="btn btn-sm btn-primary m-2" onclick="add();"  style="float:right;">Add</a>
                <a href="<?php echo base_url(session('role'));?>/project" class="btn btn-sm btn-primary m-2"  style="float:right;">Back</a>
...
<div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">Manage Task</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo base_url(session('role'));?>/project/taskStore" method="post" id="manageForm">
            <div class="modal-body">
                
                <div class="row m-2">
                    <label class="col-sm-2 col-form-label" for="title">Task</label>
                    <div class="col-sm-10 ">
    ...
    <script type="text/javascript">
        ...
        function edit(input)
        {
            $.ajax({
                  type:'get', 
                  url: '<?php echo base_url(session('role'));?>/project/taskSingleData/'+input,
                  dataType:'json',
                  data: {}, 
                  beforeSend:function()
                  {
                  ...
                  success:function(responce)
                  {
                    ...
                    }else
                    {
                      ...
                      $('#title').val(responce.message.title);
                      $('#description').val(responce.message.description);
        ...
        function deleted(input)
        {
            ...
            $.ajax({
                    type:'get', 
                    url: '<?php echo base_url(session('role'));?>/project/taskDelete/'+input,
                    dataType:'json',
                    data: {}, 
                    beforeSend:function()
                    {
