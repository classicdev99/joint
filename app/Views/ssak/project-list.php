...
<body data-sidebar="dark">
        ...
        <div class="main-content" id="result">
            <div class="page-content">
                ...
                <div class="container-fluid">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url(session('role') . '/project/task/'.$value['id']) ?>"
                                                        class="btn btn-sm btn-info"><i
                                                            class="ri-file-list-fill"></i></a>
                                                    <a href="javascript:void(0);"
                                                        onclick="show_gantt('<?php echo $value['id']; ?>')"
                                                        class="btn btn-sm btn-success"><i
                                                            class="dripicons-graph-bar"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                    ...
                    <div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo base_url(session('role'));?>/project/save" method="post"
                                    id="manageForm">
                                    <div class="modal-body">

                                        <div class="row m-2">
                                            <label class="col-sm-2 col-form-label" for="project_name">Project
                                                Name</label>
                                            <div class="col-sm-10 ">
                                        ...
                                        <div class="row m-2">
                                            <label class="col-sm-2 col-form-label" for="project_owner">Project
                                                Owner</label>
                                            <div class="col-sm-10 ">
                                        ...
                                        <div class="row m-2">
                                            <label class="col-sm-2 col-form-label" for="project_overview">Project
                                                Overview</label>
                                            <div class="col-sm-10 ">
                                        ...
                                        <div class="row m-2">
                                            <label class="col-sm-2 col-form-label" for="project_proup">Project
                                                Group</label>
                                            <div class="col-sm-10 ">
                                                <input type="text" name="project_proup" id="project_proup"
                                                    class="form-control">
                                            </div>
                                        </div>
                    ...
                    <div class="modal bs-graph-modal-xl" tabindex="-1" role="dialog"
                        aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Gantt Graph</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
    ...
    function show_gantt(input) {
        var tasks = [];
        $.ajax({
            type: 'get',
            url: '<?php echo base_url(session('role'));?>/project/graph/' + input,
            dataType: 'json',
            data: {},
            beforeSend: function() {
            ...
            success: function(responce) {
                if (responce.error) {
                    ...
                    $.each(responce.message, function(index, value) {
                        tasks.push(value);
                    });
                    $('.bs-graph-modal-xl').modal('show');
                    drawChart(tasks);
                }
            },
            error: function() {
    ...
    function drawChart(tasks) {
        ...
        for (; i < tasks.length; i++) {
            var row = [];
            row.push("" + i);
            row.push(tasks[i].title);
            row.push(new Date(tasks[i].start_date));
            row.push(new Date(tasks[i].end_date));
            row.push(null);
            row.push(0);
            row.push(null);
            rows[i] = row;
