...
<div class="modal bs-example-modal-xl" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(session('role'));?>/expenses/save" method="post" id="manageForm">
            <div class="modal-body">
                    ...
                    <div class="row m-2">
                        <label class="col-sm-2 col-form-label" for="expense_date">Expense Date</label>
                        <div class="col-sm-10 ">
                        <input type="date" name="expense_date" id="expense_date" class="form-control">
                        </div>
                    </div>
                    <div class="row m-2">
                        <label class="col-sm-2 col-form-label" for="expense_amount">Expense Amount</label>
                        <div class="col-sm-10 ">
                    ...
                    <div class="row m-2">
                        <label class="col-sm-2 col-form-label" for="expense_voucher_number">Expense Voucher Number</label>
                        <div class="col-sm-10 ">
                        <input type="text" name="expense_voucher_number" id="expense_voucher_number" class="form-control">
                        </div>
                    </div>
