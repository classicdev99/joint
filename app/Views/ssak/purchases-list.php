...
<div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(session('role'));?>/purchases/save" method="post" id="manageForm">
                <div class="modal-body">
                
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="order_date">Order Date</label>
        				<div class="col-sm-10 ">
                	...
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="seller_name">Seller Name</label>
        				<div class="col-sm-10 ">
                	...
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="order_description">Order Description</label>
        				<div class="col-sm-10 ">
        				<textarea name="order_description" id="order_description" class="form-control"></textarea>
        				</div>
                	</div>
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="order_price">Order Price</label>
        				<div class="col-sm-10 ">
        				<input type="text" name="order_price" id="order_price" class="form-control">
        				</div>
                	</div>
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="payment_mode">Payment Mode</label>
        				<div class="col-sm-10 ">
                	...
                	<div class="row m-2">
        				<label class="col-sm-2 col-form-label" for="paid_amount">Paid Amount</label>
        				<div class="col-sm-10 ">
    ...
    <script type="text/javascript">
        ...
        function edit(input)
        {
            $.ajax({
                  type:'get', 
                  url: '<?php echo base_url(session('role'));?>/purchases/edit-view/'+input,
                  dataType:'json',
                  data: {}, 
                  beforeSend:function()
                  {
                  ...
                  success:function(responce)
                  {
                    ...
                    }else
                    {
                      ...
                      $('#order_date').val(responce.message.order_date);
                      $('#invoice_date').val(responce.message.invoice_date);
                      $('#seller_name').val(responce.message.seller_name);
                      $('#invoice_number').val(responce.message.invoice_number);
                      $('#order_description').val(responce.message.order_description);
                      $('#order_price').val(responce.message.order_price);
                      $('#payment_mode').val(responce.message.payment_mode);
                      $('#paid_amount').val(responce.message.paid_amount);
                      $('.bs-example-modal-xl').modal('show');
                    }  
                  },
                  error:function()
        ...
        function deleted(input)
        {
            ...
            $.ajax({
                    type:'get', 
                    url: '<?php echo base_url(session('role'));?>/purchases/delete/'+input,
                    dataType:'json',
                    data: {}, 
                    beforeSend:function()
                    {
