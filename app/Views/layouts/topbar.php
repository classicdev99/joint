    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?= base_url(session('role').'/dashboard') ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= base_url('assets/images/logo-sm.png') ?>" alt="logo" height="25px">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="<?= base_url(session('role').'/dashboard') ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= base_url('assets/images/logo-sm.png') ?>" alt="logo" height="25px">
                    </span>
                    <span class="logo-lg">
