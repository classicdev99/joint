                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            <div class="text-center">
                                                <div>
                                                    <a href="<?= base_url() ?>" class="logo"><img src="<?php echo base_url()?>/assets/images/logo.png" height="40" alt="logo"></a>
                                                </div>
                                                <h4 class="font-size-18 mt-4">Welcome Back to <?= ucfirst($role) ?> Login !</h4>
                                                <p class="text-muted">Sign in to continue as JOINT <?= ucfirst($role) ?>.</p>
                                            </div>
                                            ...
                                            <div class="p-2 mt-5">
                                                ...
                                                <form class="" method="post" action="<?php echo base_url('/'.$role.'/postLogin') ?>" novalidate>
